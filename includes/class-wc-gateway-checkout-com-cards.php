<?php
require_once 'lib/checkout-sdk-php/checkout.php';
...
require_once 'class-wc-gateway-checkout-com-webhook.php';
require_once 'subscription/class-wc-checkout-com-subscription.php';
