...
require_once __DIR__ . '/apms/class-wc-checkoutcom-ideal.php';
require_once __DIR__ . '/apms/class-wc-checkoutcom-alipay.php';
require_once __DIR__ . '/apms/class-wc-checkoutcom-qpay.php';
require_once __DIR__ . '/apms/class-wc-checkoutcom-boleto.php';
require_once __DIR__ . '/apms/class-wc-checkoutcom-sepa.php';
require_once __DIR__ . '/apms/class-wc-checkoutcom-knet.php';
require_once __DIR__ . '/apms/class-wc-checkoutcom-bancontact.php';
require_once __DIR__ . '/apms/class-wc-checkoutcom-eps.php';
require_once __DIR__ . '/apms/class-wc-checkoutcom-poli.php';
require_once __DIR__ . '/apms/class-wc-checkoutcom-klarna.php';
require_once __DIR__ . '/apms/class-wc-checkoutcom-sofort.php';
require_once __DIR__ . '/apms/class-wc-checkoutcom-fawry.php';
require_once __DIR__ . '/apms/class-wc-checkoutcom-giropay.php';
