...
class WC_Gateway_Checkout_Com_Alternative_Payments_Sofort extends WC_Gateway_Checkout_Com_Alternative_Payments {
	...
	public function payment_fields() {
		...
		if ( ! in_array( self::PAYMENT_METHOD, $apm_available ) ) {
			?>
				<script>
					jQuery('.payment_method_wc_checkout_com_alternative_payments_sofort').hide();
				</script>
			<?php
		}
