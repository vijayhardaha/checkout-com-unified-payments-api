	...
	public static function get_boleto_details() {
		...
		<div data-role="content" class="boleto-content">
			<div class="input-group">
				...
				<input type="text" id="name" name="name" placeholder="<?php echo ( __( 'Nome' ) ); ?>" class="input-control" required style="width: 100%;">
			</div>
			<div class="input-group">
				<label class="icon" for="cpf">
					<span class="ckojs ckojs-card"></label>
				<input type="text" id="cpf" name="cpf" placeholder="<?php echo ( __( 'Cadastro de Pessoas Físicas' ) ); ?>" class="input-control" required style="width: 100%;">
			</div>
		</div>
		<?php
	}
		...
		<div class="sepa-content">
			<div class="input-group">
				<label class="icon" for="sepa-iban">
					<span class="ckojs ckojs-card"></label>
				<input type="text" id="sepa-iban" name="sepa-iban" placeholder="<?php echo ( __( 'IBAN' ) ); ?>" class="input-control" required style="width: 100%;">
			</div>
